...
func _ready():
	...
	Traverse.connect("action", GameManager._on_lobby_action)
	Talk.connect("action", GameManager._on_lobby_action)
	Use.connect("action", GameManager._on_lobby_action)
	Take.connect("action", GameManager._on_lobby_action)
	Examine.connect("action", GameManager._on_lobby_action)
