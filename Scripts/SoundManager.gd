...
var AutomatonWrite= AudioStreamPlayer.new()
...
func _ready():
	...
	add_child(AutomatonWrite)
	AutomatonWrite.stream = preload("res://Assets/Sound/Automaton_SFX.mp3")
